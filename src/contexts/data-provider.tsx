...
export const DataProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    // Inventory
    const { data: stockInRecords, loading: l_stockInRecords, add: add_stockInRecord } = useFirebase('stockInRecords');
    const { data: stockOutRecords, loading: l_stockOutRecords, add: add_stockOutRecord } = useFirebase('stockOutRecords');
    const { data: stockTransferRecords, loading: l_stockTransferRecords, add: add_stockTransferRecord } = useFirebase('stockTransferRecords');
    ...
    const { data: repRemittances, loading: l_repRemittances, add: add_repRemittance } = useFirebase('repRemittances');
    ...
    const dbAction = async (path: string, action: 'add' | 'update' | 'remove', payload?: any) => {
        const actionsMap: { [key: string]: any } = {
            ...
            'repRemittances': { add: add_repRemittance },
