                ...
                {itemGroups.map((group: ItemGroup) => (
                  <Card key={group.id} className="flex flex-col">
                    ...
                    <CardContent className="flex-grow flex flex-col items-center justify-center gap-2">
                        <Image src={group.image || "https://placehold.co/100x100.png"} alt={group.name || "Group Image"} width={80} height={80} className="rounded-lg object-cover" data-ai-hint="product category" />
