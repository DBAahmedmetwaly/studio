...
const PartnerForm = ({ partner, onSave, onClose }: { partner?: Partner, onSave: (partner: Partner) => void, onClose: () => void }) => {
  const [formData, setFormData] = useState<Partner>(
    partner || { name: "", capital: 0, profitShare: 0 }
  );
...
export default function PartnersPage() {
    const { data: partners, loading, add, update, remove } = useFirebase<Partner>("partners");
                            ...
                            <TableRow key={partner.id}>
                                ...
                                <TableCell>
                                    <DropdownMenu>
                                        ...
                                        >
                                           <PartnerForm partner={partner} onSave={handleSave} />
                                        </AddEntityDialog>
